...
latex_documents = [
    (master_doc, 'ThothsGraphSynchronizationJobforOpenShift.tex', 'Thoth\'s Graph Synchronization Job for OpenShift Documentation',
     'goern, fpokorny', 'manual'),
]
...
man_pages = [
    (master_doc, 'thothsgraphsynchronizationjobforopenshift', 'Thoth\'s Graph Synchronization Job for OpenShift Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ThothsGraphSynchronizationJobforOpenShift', 'Thoth\'s Graph Synchronization Job for OpenShift Documentation',
     author, 'ThothsGraphSynchronizationJobforOpenShift', 'One line description of project.',
     'Miscellaneous'),
]
